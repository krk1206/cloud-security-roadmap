...
- `03-cloud-basics`: AWS 핵심 서비스(VPC, EC2, S3) 및 프라이빗 클라우드 개념 정리
- `04-container-basics`: Docker 컨테이너 격리 기술 및 Kubernetes 기초 실습 *(진행 예정)*
- `05-capstone-project`: DevSecOps 기반 AI 보안 취약점 자동 스캐닝 파이프라인 구축 *(진행 예정)*
...
- **Security**: ufw, Wireshark, Port Scanning Analysis
...
- [ ] 캡스톤 프로젝트 프로토타입 기획서 완성 (`05-capstone-project`)